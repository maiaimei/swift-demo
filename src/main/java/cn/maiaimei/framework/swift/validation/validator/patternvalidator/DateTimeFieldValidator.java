...
/**
 * Dates defined as 8!n4!n must be in the form of YYYYMMDDHHMM. Dates defined as 8!n must be in the
 * form of YYYYMMDD. Dates defined as 6!n must be in the form of YYMMDD Times defined as 4!n must be
 * in the form of HHMM
 */
@Component
public class DateTimeFieldValidator implements PatternFieldValidator {
    ...
    private static final Pattern VALIDATOR_PATTERN_01_PATTERN =
            Pattern.compile(VALIDATOR_PATTERN_01_REGEX);
    private static final List<String> VALIDATOR_PATTERN_LIST =
            Collections.singletonList(VALIDATOR_PATTERN_01);
    ...
    private static final List<String> PATTERN_LIST =
            Arrays.asList(PATTERN_YYYYMMDDHHMM, PATTERN_YYYYMMDD, PATTERN_YYMMDD, PATTERN_HHMM);
