...
public class MTConfigParser {
    ...
    public static void parse(Element element, BeanDefinitionRegistry registry) {
        ...
        if (!CollectionUtils.isEmpty(childElements)) {
            for (Element childElement : childElements) {
                ...
                doParse(childElement, registry, beanClass);
            }
        }
    }

    private static void doParse(Element element, BeanDefinitionRegistry registry, Class<?> beanClass) {
    ...
    private static void parseSequences(Element element, BeanDefinitionBuilder builder) {
        parseElements(element, SEQUENCES, SEQUENCE, SEQUENCES, builder, MTConfigParser::parseSequenceInfo);
    }

    private static void parseFields(Element element, BeanDefinitionBuilder builder) {
        parseElements(element, FIELDS, FIELD, FIELDS, builder, MTConfigParser::parseFieldInfo);
    }

    private static void parseComponents(Element element, BeanDefinitionBuilder builder) {
        parseElements(element, COMPONENTS, COMPONENT, COMPONENTS, builder, MTConfigParser::parseComponentInfo);
    }

    private static void parseRules(Element element, BeanDefinitionBuilder builder) {
        parseElements(element, RULES, RULE, RULES, builder, MTConfigParser::parseRuleInfo);
    }

    private static void parseElements(Element element, String childEleName, String grandsonEleName,
                                      String propertyName,
    ...
    private static BeanDefinition parseSequenceInfo(Element element) {
    ...
    private static BeanDefinition parseFieldInfo(Element element) {
    ...
    private static BeanDefinition parseComponentInfo(Element element) {
    ...
    private static void parseFieldComponentInfo(Element element, BeanDefinitionBuilder builder) {
    ...
    private static BeanDefinition parseRuleInfo(Element element) {
    ...
    private static void addPropertyValue(Element element, BeanDefinitionBuilder builder, String propertyName, String attributeName) {
        if (element.hasAttribute(attributeName)) {
            builder.addPropertyValue(propertyName, element.getAttribute(attributeName));
        }
    }

    private MTConfigParser() {
