...
public class MT725Transaction extends MT798Transaction {

  private MT725IndexMessage indexMessage;
  private List<MT725DetailMessage> detailMessages;

  @Data
  @EqualsAndHashCode(callSuper = true)
  public static class MT725IndexMessage extends MT798IndexMessage {
    @Tag("21A")
  ...
  @Data
  @EqualsAndHashCode(callSuper = true)
  public static class MT725DetailMessage extends MT798DetailMessage {
    @Tag("21P")
    private String bankReferenceNumber;
